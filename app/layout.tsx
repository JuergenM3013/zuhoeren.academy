...
})(window,document,'script','dataLayer','GTM-534GQ832');`}
        </Script>
        <Script src="https://www.googletagmanager.com/gtag/js?id=G-BCTNTX5S20" strategy="afterInteractive" />
        <Script id="gtag" strategy="afterInteractive">
          {`window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'G-BCTNTX5S20');`}
        </Script>
        <script
      ...
      <body className={`${inter.className} min-h-screen bg-slate-950 text-slate-50 antialiased`}>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-534GQ832"
            height="0"
            width="0"
