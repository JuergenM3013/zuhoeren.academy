...
export const platforms: Platform[] = [
  {
    slug: "salesfitness",
    name: "SalesFitness",
    website: "https://salesfitness.academy",
    category: "Sales",
    status: "live",
    statusLabel: "Live",
    tagline: "KI-gestützte Sales-Performance — Analyse, Simulation & Coaching in Phasen.",
    description:
  ...
  },
  {
    slug: "dialogfitness",
    name: "DialogFitness",
    website: "https://dialogfitness.academy",
    category: "Dialog",
    status: "live",
    statusLabel: "Live",
    tagline: "Gesprächsführung trainieren: Listening, Feedback, schwierige Gespräche — mit KI-Simulationen.",
    description:
  ...
  },
  {
    ...
    status: "live",
    statusLabel: "Live",
    tagline: "Besser denken, besser entscheiden: Denkfallen erkennen, reflektieren, umsetzen.",
    description:
    ...
    seo: {
      ...
      description: "KI-gestützte Lernplattform für Metakognition: Denkfallen erkennen, Reflexion stärken und Entscheidungsqualität verbessern — praxisnah & transferorientiert.",
    },
  },
  {
    ...
    status: "live",
    statusLabel: "Live",
    tagline: "Resilienz im Arbeitsalltag: wissenschaftlich fundiert, praktisch, sicher.",
    description:
      "ResilienzFitness bietet Resilienz-Training mit Modulen, Übungen, KI-Coaching-Tools und Assessments. Fokus: Selbstregulation, mentale Flexibilität, gesunde Routinen — mit klarer Safety-Abgrenzung (kein Therapie-Ersatz).",
    bullets: [
      "Module & Übungen (z. B. Stressregulation, Ressourcen, Routinen)",
      "Validierte Assessments & Fortschrittslogik",
      "Safety: klare Grenzen, Hinweise, Eskalationspfade (je nach Setup)",
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["Selbsteinschätzungen", "Hinweise bei Belastung", "Ressourcen- & Hilfe-Links (optional)"],
      },
    ],
    seo: {
  ...
  },
  {
    ...
    status: "live",
    statusLabel: "Live",
    tagline: "Leadership als Skill: Training, Feedback, Transfer — wissenschaftlich fundiert.",
    description:
    ...
    bullets: [
      "Wissenschaftlich fundiert (z. B. Kahneman, Goleman, Edmondson, Transaktionsanalyse)",
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["Führungsstil", "Sicherheitsklima", "Entscheidungsroutinen (optional)"],
      },
    ],
    seo: {
